...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，下一章[05.05 Go 调度模型](../../../src/docs/platform_engineering/curriculum/05_runtime/05_scheduler_model.md)从“可见性”转向 Go 的 G/M/P 调度、系统调用等待与网络轮询职责。离开本章前，应能为每个共享读写指出**同步边**，并说明**无数据竞争、完整业务快照和跨进程提交**分别需要什么保证。
