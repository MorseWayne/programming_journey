...
能在群规模、离线时长、故障域或旧端条件变化时重新界定承诺、手算工作量、比较扇出/历史/部署候选，并用反例指出尚不能批准的部分，才算完成第一轮答辩。下一章[13.12 工程师的长期责任](../../../src/docs/platform_engineering/curriculum/13_architecture/12_engineer_long_term_responsibility.md)将收束运行、评审、指导和长期决策。
