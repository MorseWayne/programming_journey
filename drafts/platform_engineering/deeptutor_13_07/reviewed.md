...
能把未来 S3 的用户目标、当前 S2 合同、候选方案、数据/故障流、容量假设、验证门和决定状态写成让别人可反驳的文档，并解释 proposed ADR 为何不能冒充已实现，才算完成第一轮。下一章[13.08 迁移与兼容](../../../src/docs/platform_engineering/curriculum/13_architecture/08_migration_compatibility.md)将进入权威数据、旧客户端与读写路径的分阶段演进。
