...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，下一章[06.09 日志与崩溃恢复](../../../src/docs/platform_engineering/curriculum/06_databases/09_logging_recovery.md)继续追问：数据库已决定/已提交的消息，在哪些故障点还能恢复？06.11–06.12 才把复制、迁移与业务存储案例组合起来。
