...
下一章是[01.07 错误与资源生命周期](../../../src/docs/platform_engineering/curriculum/01_go/07_errors_resources.md)：用 error、defer 和 Reader/Writer 解释文件操作的失败与关闭责任。当前内存存储不等同于文件实现。
