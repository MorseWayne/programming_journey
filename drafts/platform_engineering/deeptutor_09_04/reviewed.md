...
下一批按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)补 09.08 的输入/输出防护、11 卷的基本观测与 10.09 CI，再进入 S3 的持久数据与真实身份。离开本章前，请能说清“panic 恢复”“请求取消”“HTTP 500”“服务内存状态”四者为何互不等价。
