...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，下一章 05.11 比较减少分配、池化、批量和局部性时应守住的正确性与维护边界。离开本章前，应能说出**每种工具采样了哪一层、看不到哪一层，以及何种同负载证据才能支持一次 IM 优化**。
