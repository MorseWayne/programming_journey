...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，下一章[06.07 事务与并发异常](../../../src/docs/platform_engineering/curriculum/06_databases/07_transactions_anomalies.md)回到“检查成员资格和写消息怎样作为一个操作，以及并发会发生什么”；06.05–06.06 的索引与执行计划在 S4 深化。离开本章前，要能画出**谁拥有 DB/Client、谁拥有 Rows/Cursor、何时释放、超时时还能确认什么**。
