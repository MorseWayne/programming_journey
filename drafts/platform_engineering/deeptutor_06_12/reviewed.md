...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，接下来先读[08.01 系统模型与部分失败](../../../src/docs/platform_engineering/curriculum/08_distributed/01_system_partial_failure.md)并完成 08.02–08.04 的时间、复制与一致性前置，再进入第七卷的缓存、派生状态与消息中间件。
