...
按[学习路线](../../../src/docs/platform_engineering/curriculum/learning_path.md)，下一章[09.07 认证与授权](../../../src/docs/platform_engineering/curriculum/09_backend_security/07_authentication_authorization.md)进一步讲凭据、会话、Token、会话成员授权和撤销；09.08 再系统讲输出编码、SQL 注入、文件/URL 与敏感日志。离开本章前，应能说明**浏览器来源、登录主体、用户意图、会话资源权限和设备送达各需要哪份独立证据**。
