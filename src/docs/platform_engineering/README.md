...
当前已有 **17 章独立长篇正文、35 课入门与衔接正文、14 篇分卷专题讲义**，以及 **14 卷共 168 个章节单元的教学设计**。168 个单元均已列出具体 IM 练习与验收目标；正文完成 01.01–01.09、02.01–02.04、03.01、10.01–10.03；最新章节用消息复合键讲解哈希、集合和有限去重窗口。前两章和部分旧短课、core 的原案例继续作为基础补充，其余长篇按先修关系展开。
...
| 02 | [数学基础、数据结构与问题求解](./curriculum/02_algorithms/README.md) | [02.01 数学与成本](./curriculum/02_algorithms/01_discrete_cost.md) · [02.02 线性结构](./curriculum/02_algorithms/02_linear_structures.md) · [02.03 搜索](./curriculum/02_algorithms/03_search_invariants.md) · [02.04 哈希](./curriculum/02_algorithms/04_hash_sets.md) · [专题讲义](./curriculum/02_algorithms/core.md) |
