...
| 课程 | 资料 | 带着什么问题读 |
|---|---|---|
| 01 | [Go 错误处理](https://go.dev/blog/error-handling-and-go) | 错误如何成为调用契约的一部分？ |
...
| 05 | [HBase Rowkey Design](https://hbase.apache.org/book.html#rowkey.design) | 行键如何同时影响扫描和热点？ |
...
| 08 | [NATS Consumers](https://docs.nats.io/nats-concepts/jetstream/consumers) | 确认与重投如何影响消费者？ |
