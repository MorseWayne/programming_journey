...
| [04.12 网络排障与协议演进](./12_network_diagnostics_evolution.md) | 抓包读法、阶段计时、失败分类、兼容矩阵与限额。 | 提交一次断线或投递延迟排障，包含阶段计时、抓包观察与协议兼容边界。 |
