...
当前包含 **14 卷分章设计、168 个章节单元、15 章独立长篇正文、35 课入门与衔接正文，以及 14 篇专题讲义**。Go 主线已完成 01.01–01.09；数学与算法主线已完成 [02.01 数学成本](./02_algorithms/01_discrete_cost.md)与[02.02 线性结构](./02_algorithms/02_linear_structures.md)；系统主线已完成 [03.01 数据与存储](./03_systems/01_data_instructions_storage.md)；工程主线已完成 [10.01–10.03](./10_engineering/README.md)。168 个单元已有逐项 IM 练习与验收目标，尚未全部写成独立教材正文，详见[编写与能力验收](./assessment.md)。
...
| [02 · 数学基础、数据结构与问题求解](./02_algorithms/README.md) | A02–A06；原课程缺少独立主线 | [02.01 数学与成本](./02_algorithms/01_discrete_cost.md) · [02.02 线性结构](./02_algorithms/02_linear_structures.md) · [专题讲义](./02_algorithms/core.md) |
