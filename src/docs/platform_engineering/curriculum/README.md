...
| [10 · 测试、Git、代码质量与团队交付](./10_engineering/README.md) | A08–A09；原内容缺少长期维护和协作过程 | [10.01 需求](./10_engineering/01_verifiable_requirements.md) · [10.02 测试](./10_engineering/02_testing_basics.md) · [10.03 Git](./10_engineering/03_git_state.md) · [10.04 替身](./10_engineering/04_test_doubles_design.md) · [10.05 重构](./10_engineering/05_refactoring_boundaries.md) · [专题讲义](./10_engineering/core.md) |
