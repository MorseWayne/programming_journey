...
| [02 · 数学基础、数据结构与问题求解](./02_algorithms/README.md) | A02–A06；原课程缺少独立主线 | [02.01 数学与成本](./02_algorithms/01_discrete_cost.md) · [02.02 线性结构](./02_algorithms/02_linear_structures.md) · [02.03 搜索](./02_algorithms/03_search_invariants.md) · [02.04 哈希](./02_algorithms/04_hash_sets.md) · [02.05 排序](./02_algorithms/05_sort_divide.md) · [02.06 树](./02_algorithms/06_trees_ordered_index.md) · [02.07 堆](./02_algorithms/07_heap_priority_scheduling.md) · [02.08 图](./02_algorithms/08_graph_dependency_traversal.md) · [02.09 带权路径](./02_algorithms/09_weighted_paths_state_space.md) · [02.10 动态规划](./02_algorithms/10_dynamic_programming_greedy.md) · [专题讲义](./02_algorithms/core.md) |
