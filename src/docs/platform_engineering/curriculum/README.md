...
当前包含 **14 卷分章设计、168 个章节单元、24 章独立长篇正文、35 课入门与衔接正文，以及 14 篇专题讲义**。Go 主线已完成 01.01–01.09 与 [01.12 CLI](./01_go/12_cli_capstone.md)；数学与算法主线已完成 [02.01–02.05](./02_algorithms/README.md)；系统主线已完成 [03.01–03.03](./03_systems/README.md)；工程主线已完成 [10.01–10.06](./10_engineering/README.md)。168 个单元已有逐项 IM 练习与验收目标，尚未全部写成独立教材正文，详见[编写与能力验收](./assessment.md)。
...
| [03 · 计算机系统、操作系统与 Linux](./03_systems/README.md) | B01、B04；原内容只介绍了进程与容器外观 | [03.01 数据与存储](./03_systems/01_data_instructions_storage.md) · [03.02 进程与系统调用](./03_systems/02_process_syscalls.md) · [03.03 Linux 资源](./03_systems/03_linux_process_resources.md) · [专题讲义](./03_systems/core.md) |
