...
| [08 · 分布式系统、一致性与故障恢复](./08_distributed/README.md) | C08–C09；复制与共识主干待续 | [08.01 部分失败](./08_distributed/01_system_partial_failure.md) · [08.02 时间与顺序](./08_distributed/02_time_order.md) · [专题讲义](./08_distributed/core.md) |
