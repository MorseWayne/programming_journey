...
当前包含 **14 卷分章设计、168 个章节单元、20 章独立长篇正文、35 课入门与衔接正文，以及 14 篇专题讲义**。Go 主线已完成 01.01–01.09 与 [01.12 CLI](./01_go/12_cli_capstone.md)；数学与算法主线已完成 [02.01–02.05](./02_algorithms/README.md)；系统主线已完成 [03.01 数据与存储](./03_systems/01_data_instructions_storage.md)；工程主线已完成 [10.01–10.04](./10_engineering/README.md)。168 个单元已有逐项 IM 练习与验收目标，尚未全部写成独立教材正文，详见[编写与能力验收](./assessment.md)。
...
| [10 · 测试、Git、代码质量与团队交付](./10_engineering/README.md) | A08–A09；原内容缺少长期维护和协作过程 | [10.01 需求](./10_engineering/01_verifiable_requirements.md) · [10.02 测试](./10_engineering/02_testing_basics.md) · [10.03 Git](./10_engineering/03_git_state.md) · [10.04 替身](./10_engineering/04_test_doubles_design.md) · [专题讲义](./10_engineering/core.md) |
