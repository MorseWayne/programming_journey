...
当前包含 **14 卷分章设计、168 个章节单元、168 章独立长篇正文、35 课入门与衔接正文，以及 14 篇专题讲义**。Go 主线已完成 [01.01–01.12](./01_go/README.md)，含 [01.12 CLI](./01_go/12_cli_capstone.md)；数学与算法主线已完成 [02.01–02.12](./02_algorithms/README.md)；系统主线已完成 [03.01–03.12](./03_systems/README.md)；网络主线已完成 [04.01–04.12](./04_networks/README.md)；并发主线已完成 [05.01–05.12](./05_runtime/README.md)；数据库主线已完成 [06.01–06.12](./06_databases/README.md)；缓存与消息主线已完成 [07.01–07.12](./07_cache_messaging/README.md)；分布式主线已完成 [08.01–08.12](./08_distributed/README.md)；应用主线已完成 [09.01–09.12](./09_backend_security/README.md)；工程主线已完成 [10.01–10.12](./10_engineering/README.md)；可靠性主线已完成 [11.01–11.12](./11_reliability/README.md)；平台主线已完成 [12.01–12.12](./12_platform/README.md)；架构主线已完成 [13.01–13.12](./13_architecture/README.md)；AI 支线已完成 [14.01–14.12](./14_ai/README.md)。168 个单元已有逐项 IM 练习与验收目标，且均已写成独立教材正文，详见[编写与能力验收](./assessment.md)。
...
| [12 · 容器、Kubernetes 与平台运行](./12_platform/README.md) | B04、C11；原内容仅基础清单与生命周期 | [12.01 运行环境与制品](./12_platform/01_runtime_artifacts.md) · [12.02 容器机制](./12_platform/02_container_mechanisms.md) · [12.03 本地多服务](./12_platform/03_local_multi_service.md) · [12.04 集群控制](./12_platform/04_cluster_control_model.md) · [12.05 工作负载](./12_platform/05_workloads_service_discovery.md) · [12.06 资源存储](./12_platform/06_resources_persistent_storage.md) · [12.07 配置权限](./12_platform/07_config_permissions.md) · [12.08 探针退出](./12_platform/08_startup_probes_exit.md) · [12.09 发布回滚](./12_platform/09_release_rollback.md) · [12.10 扩缩容](./12_platform/10_autoscaling_fault_domains.md) · [12.11 声明式交付](./12_platform/11_declarative_delivery.md) · [12.12 平台产品](./12_platform/12_platform_as_product.md) · [专题讲义](./12_platform/core.md) |
| [13 · 软件设计、架构决策与高级工程实践](./13_architecture/README.md) | C12、D05–D06；原内容缺少长期演进与协作案例 | [13.01 问题定义](./13_architecture/01_problem_stakeholders.md) · [13.02 领域状态](./13_architecture/02_domain_state_modeling.md) · [13.03 模块边界](./13_architecture/03_modules_information_hiding.md) · [13.04 架构风格](./13_architecture/04_architecture_styles_boundaries.md) · [13.05 容量数据](./13_architecture/05_capacity_data_design.md) · [13.06 质量取舍](./13_architecture/06_quality_attribute_tradeoffs.md) · [13.07 设计评审](./13_architecture/07_design_review_adr.md) · [13.08 迁移兼容](./13_architecture/08_migration_compatibility.md) · [13.09 跨团队交付](./13_architecture/09_cross_team_delivery.md) · [13.10 技术债](./13_architecture/10_technical_debt_evolution.md) · [13.11 案例答辩](./13_architecture/11_complex_im_defense.md) · [13.12 长期责任](./13_architecture/12_engineer_long_term_responsibility.md) · [专题讲义](./13_architecture/core.md) |
| [14 · AI 基础、检索、Agent 与应用评测](./14_ai/README.md) | D01–D04；原先只覆盖关键词基线与工具恢复 | [14.01 Python 与数据](./14_ai/01_python_data_work.md) · [14.02 数学与机器学习](./14_ai/02_math_ml_intuition.md) · [14.03 语言模型](./14_ai/03_language_model_foundations.md) · [14.09 评测基线](./14_ai/09_evaluation_data_engineering.md) · [14.04 推理路径](./14_ai/04_transformer_inference_path.md) · [14.05 提示与输出](./14_ai/05_prompt_structured_output.md) · [14.06 检索与索引](./14_ai/06_retrieval_indexing.md) · [14.07 RAG 链路](./14_ai/07_rag_pipeline.md) · [14.08 工具工作流](./14_ai/08_tools_workflows_agents.md) · [14.10 优化与部署](./14_ai/10_optimization_deployment.md) · [14.11 微调与多模态](./14_ai/11_finetuning_multimodal.md) · [14.12 可持续交付](./14_ai/12_sustainable_delivery.md) · [专题讲义](./14_ai/core.md) |
