---
title: 02.04 哈希与集合：在有限窗口内识别重复消息身份
icon: /assets/icons/article.svg
order: 5
date: 2026-09-24
---

[返回第二卷](./README.md) · [上一章：搜索与循环不变量](./03_search_invariants.md) · [学习路线](../learning_path.md)
...
下一章[02.05 排序与分治](./05_sort_divide.md)讲明当业务需要按序号、时间和次级键展示或范围读取消息时，如何定义比较规则并计算排序成本。
