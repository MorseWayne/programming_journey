---
title: 05.10 性能工具与解释：从群聊时延到 Go 运行证据
icon: /assets/icons/article.svg
order: 11
date: 2026-09-24
---

[返回第五卷](./README.md) · [GC 前置：05.07](./07_garbage_collection.md) · [组合前置：05.08](./08_concurrency_composition.md) · [验证前置：05.09](./09_concurrency_verification.md) · [诊断前置：03.10](../03_systems/10_system_diagnostics.md)
