---
title: 09.06 浏览器与客户端边界：Cookie、跨源与 IM 请求
icon: /assets/icons/article.svg
order: 7
date: 2026-09-24
---

[返回第九卷](./README.md) · [HTTP/WS 前置：04.03](../04_networks/03_http_websocket_basics.md) · [接口合同：09.02](./02_http_api_contract.md) · [数据边界：09.05](./05_data_access_migration.md)
