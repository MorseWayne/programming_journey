...
完成本章规则练习后，进入[01.12 本地 CLI](../01_go/12_cli_capstone.md)组织完整工具，再读[10.04 测试替身与设计](./04_test_doubles_design.md)学习可控依赖。学习者在自己的目录完成 6/9/10 字节变式，并把“预期”“实际”“未覆盖范围”分开记录。
